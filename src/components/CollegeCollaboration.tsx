          ...
          >
            ...
            <div>
              <div className="mini-badge">
                ...
                <span>College Collaboration</span>
              </div>

              <h2 className="main-heading">
                Empowering Students with <span>AI Skills</span>
              </h2>

              <p className="main-text">
                We conduct modern AI workshops, seminars, and practical
                training sessions that help students learn real-world tools
                used in today’s industries.
              </p>

              <p className="main-text">
                Our goal is to bridge the gap between academics and industry
                by helping students become future-ready with hands-on AI and
                digital skills.
              </p>
            ...
            <div>
              <div className="glass-card">
                ...
                <h3 className="card-title">AI Skills for the Future</h3>

                <p className="card-desc">
                  Workshops conducted in colleges across Nagpur with
        ...
        >
          ...
          >
            ...
            <h2 className="showcase-heading">
              Trusted by <span>Colleges & Institutions</span>
            </h2>

            <p className="showcase-subtext">
              We collaborate with colleges through workshops, seminars, AI
              training programs, and official MoU partnerships to empower
            ...
            {collaborations.map((item, index) => (
              <div className="college-card" key={index}>
                ...
                <div className="college-image-wrap">
                  ...
                  <div className="college-tag">{item.tag}</div>
                </div>
      ...
      <style>{`
        * {
        ...
        .explore-btn {
          ...
          cursor: pointer;
          transition: 0.3s ease;
          box-shadow: 0 10px 25px rgba(245,183,49,0.2);
        }

        .partner-btn:hover,
        .explore-btn:hover {
          transform: translateY(-4px);
          box-shadow: 0 16px 35px rgba(245,183,49,0.28);
        }
